...
const AllCars = () => {
  ...
  let [totalPages, setTotalPage] = useState(1);
    ...
    <main className="w-full">
      ...
      {!loader && (
        <div className="w-10/12 mx-auto mt-2">
          <h1 className="text-3xl font-bold text-sky-700 text-shadow-xs text-shadow-amber-700">
            All Cars
          </h1>
          <LazyLoadImage
            src="/Images/AllCarLogo.jpg"
            className="w-full object-cover h-80 rounded-lg mt-4 mb-4"
            alt=""
          />
            ...
            {data.map((car, index) => (
              <div
                ...
                <div className="w-11/12 mx-auto flex flex-col justify-between border-b py-3 pb-4 gap-2">
                  <h1 className="w-full font-semibold text-md px-2  shadow shadow-slate-300 py-1 rounded-sm bg-slate-100 text-black">
                ...
                <div className="price flex justify-between items-center w-11/12 mx-auto my-1">
            ...
            {showBtn && page > 1 && (
              <div className="flex items-center justify-center">
                <button
                  ...
                  className="border px-2 py-1 bg-blue-600 text-white rounded-md cursor-pointer">
                  Previous Page
                </button>
              </div>
            )}
